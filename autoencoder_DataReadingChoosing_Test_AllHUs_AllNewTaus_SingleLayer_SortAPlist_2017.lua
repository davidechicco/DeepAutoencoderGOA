...
print('test version WITHOUT the 10% noise in the input matrix and with generation of tests results on XML files');
...
-- 	print('if '..h..' >= '..sampleNumber..' then break; end');
	...
	print('threshold fixed\n');
	  ...
	  print('topK annotations= ' ..topK);
	   experiment = experiment .. " threshold=".. threshold .. " HUs=" .. HUs ..  " topK=" .. topK .. '\n';
